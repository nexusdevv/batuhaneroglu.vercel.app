  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'Discord Clone',
      description: 'Full-stack Discord replica with WebSocket integration, role-based permissions, and real-time voice channels.',
      icon: (
    ...
    },
    {
      ...
      description: "You're seeing it rn.",
      icon: (
        <svg className="w-12 h-12 text-zinc-400 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      id: 3,
      title: 'Discord Bot',
      description: 'AI-powered bot with natural language processing, automated moderation, and custom plugin system.',
      icon: (
        <svg className="w-12 h-12 text-zinc-400 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-3.5-9c.83 0 1.5-.67 1.5-1.5S9.33 8 8.5 8 7 8.67 7 9.5 7.67 11 8.5 11zm7 0c.83 0 1.5-.67 1.5-1.5S16.33 8 15.5 8 14 8.67 14 9.5s.67 1.5 1.5 1.5zm-3.5 3c-1.1 0-2 .9-2 2h4c0-1.1-.9-2-2-2z"/>
        </svg>
      )
    }
  ];
                ...
                {projects.map(project => (
                  <div key={project.id} className="group relative bg-gradient-to-b from-black to-zinc-950/50 rounded-2xl border border-zinc-800/50 hover:border-zinc-700/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-zinc-900/10">
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <h3 className="text-xl font-bold bg-gradient-to-r from-zinc-300 to-zinc-100 bg-clip-text text-transparent">{project.title}</h3>
                  ...
                  <>
                    <div className="group relative bg-gradient-to-b from-zinc-700/50 to-zinc-950/30 rounded-2xl border border-zinc-800/30 opacity-50">
                      <div className="p-6 space-y-4">
                        ...
                        <h3 className="text-xl font-bold text-zinc-500/70">Coming Soon</h3>
                        <p className="text-zinc-600/50 leading-relaxed">Future project in development...</p>
                      </div>
                    </div>
